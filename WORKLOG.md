...
## 2026-06-29, интервал smart-рассылки 24 часа

### Сделано

- Интервал автоматической smart-рассылки изменен с 12 часов на 24 часа.
- Финальный админский текст после рассылки теперь сообщает: `Следующая рассылка через 24 часа.`
- `tools/smoke_local.py` проверяет, что `CYCLE_SLEEP_SEC == 24 * 60 * 60`.
